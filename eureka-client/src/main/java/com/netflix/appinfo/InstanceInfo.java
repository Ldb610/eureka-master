...
public class InstanceInfo {
    ...
    public enum InstanceStatus {
        ...
        //表示服务已经宕机，无法继续提供服务
        DOWN, // Do not send traffic- healthcheck callback failed 不发送流量- healthcheck回调失败
        // 表示服务正在启动中
        STARTING, // Just about starting- initializations to be done - do not 只是关于开始-初始化要做-不要
        // send traffic
        // 不再提供服务，其他的Eureka Client将调用不到该服务，一般有人为的调用接口设置的，如：强制下线。
